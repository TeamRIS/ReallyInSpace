...
@RisModElements.ModElement.Tag public class LanderEntity extends RisModElements.ModElement {
	...
	@Override public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
					...
					.immuneToFire().size(0.6f, 1.8f))
					.build("lander").setRegistryName("lander");

		elements.entities.add(() -> entity);

		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -1,
				new Item.Properties().group(RISItemGroup.tab))
				.setRegistryName("lander_spawn_egg"));
	...
	public static class CustomEntity extends MonsterEntity implements IAnimatedEntity {
		...
		@Override protected void registerGoals() {
			super.registerGoals();
                ...
                this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, false));this.goalSelector.addGoal(2, new RandomWalkingGoal(this, 1));this.targetSelector.addGoal(3, new HurtByTargetGoal(this)
);this.goalSelector.addGoal(4, new LookRandomlyGoal(this));this.goalSelector.addGoal(5, new SwimGoal(this));
