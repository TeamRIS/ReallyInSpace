...
@RisModElements.ModElement.Tag public class AilenEntity extends RisModElements.ModElement {
	...
	@Override public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
					.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
					.size(0.6f, 1.8f))
					.build("ailen").setRegistryName("ailen");

		elements.entities.add(() -> entity);

		elements.items.add(() -> new SpawnEggItem(entity, -65485, -13369549,
				new Item.Properties().group(RISItemGroup.tab))
				.setRegistryName("ailen_spawn_egg"));
	...
	@Override public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			biome.getSpawns(EntityClassification.CREATURE).add(new Biome.SpawnListEntry(entity, 31,
							4, 4));
		}
	...
	public static class CustomEntity extends CreatureEntity implements IAnimatedEntity {
		...
		@Override protected void registerGoals() {
			super.registerGoals();
                ...
                this.goalSelector.addGoal(1, new RandomWalkingGoal(this, 1));this.goalSelector.addGoal(2, new LookRandomlyGoal(this));this.goalSelector.addGoal(3, new SwimGoal(this));
