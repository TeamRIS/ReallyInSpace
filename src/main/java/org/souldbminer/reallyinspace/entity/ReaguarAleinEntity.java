...
@RisModElements.ModElement.Tag public class ReaguarAleinEntity extends RisModElements.ModElement {
	...
	@Override public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -52429, -13369549,
	...
	public static class CustomEntity extends CreatureEntity implements IAnimatedEntity {
		...
		@Override protected void registerGoals() {
			super.registerGoals();
                ...
                this.goalSelector.addGoal(1, new RandomWalkingGoal(this, 1));this.goalSelector.addGoal(2, new LookRandomlyGoal(this));this.goalSelector.addGoal(3, new SwimGoal(this));this.goalSelector.addGoal(4, new LeapAtTargetGoal(this, (float)0.5));
