...
@RisModElements.ModElement.Tag public class AilenBossEntity extends RisModElements.ModElement {
	...
	@Override public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -65536, -16776961,
...
this.goalSelector.addGoal(3, new MeleeAttackGoal(this, 1.2, false));this.goalSelector.addGoal(4, new LookRandomlyGoal(this));this.targetSelector.addGoal(5,
        new NearestAttackableTargetGoal(this, PlayerEntity.class, true,
        true));this.targetSelector.addGoal(6, new HurtByTargetGoal(this)
);
