...
@RisModElements.ModElement.Tag public class RocketEntity extends RisModElements.ModElement {
	...
	@Override public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
					...
					.build("rocket").setRegistryName("rocket");

		elements.entities.add(() -> entity);

		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -11513776,
