...
@RisModElements.ModElement.Tag public class Tier2rocketEntity extends RisModElements.ModElement {
	...
	@Override public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -13369498,
