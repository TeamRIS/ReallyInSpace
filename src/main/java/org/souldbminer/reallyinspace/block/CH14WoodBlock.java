...
public class CH14WoodBlock extends RisModElements.ModElement {
	@ObjectHolder("ris:ch_14_wood")
	public static final Block block = null;
	public CH14WoodBlock(RisModElements instance) {
		super(instance, 115);
	}
