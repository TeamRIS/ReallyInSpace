...
public class CH15LeavesBlock extends RisModElements.ModElement {
	@ObjectHolder("ris:ch_15_leaves")
	public static final Block block = null;
	public CH15LeavesBlock(RisModElements instance) {
		super(instance, 134);
	}
