...
public class CH14FenceBlock extends RisModElements.ModElement {
	@ObjectHolder("ris:ch_14_fence")
	public static final Block block = null;
	public CH14FenceBlock(RisModElements instance) {
		super(instance, 121);
	}
