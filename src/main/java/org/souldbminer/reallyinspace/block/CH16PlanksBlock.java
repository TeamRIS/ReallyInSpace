...
public class CH16PlanksBlock extends RisModElements.ModElement {
	@ObjectHolder("ris:ch_16_planks")
	public static final Block block = null;
	public CH16PlanksBlock(RisModElements instance) {
		super(instance, 168);
	}
