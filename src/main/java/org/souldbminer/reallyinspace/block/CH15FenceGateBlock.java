...
public class CH15FenceGateBlock extends RisModElements.ModElement {
	@ObjectHolder("ris:ch_15_fence_gate")
	public static final Block block = null;
	public CH15FenceGateBlock(RisModElements instance) {
		super(instance, 138);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("ch_15_fence_gate");
		}
