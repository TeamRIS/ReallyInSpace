...
public class CH15StairsBlock extends RisModElements.ModElement {
	@ObjectHolder("ris:ch_15_stairs")
	public static final Block block = null;
	public CH15StairsBlock(RisModElements instance) {
		super(instance, 135);
	}
