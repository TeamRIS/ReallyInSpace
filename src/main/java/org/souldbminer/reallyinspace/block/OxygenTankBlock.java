...
public class OxygenTankBlock extends RisModElements.ModElement {
	@ObjectHolder("ris:oxygen_tank")
	public static final Block block = null;
	@ObjectHolder("ris:oxygen_tank")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public OxygenTankBlock(RisModElements instance) {
		super(instance, 254);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("oxygen_tank"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("oxygen_tank");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Oxygen Tank");
		}
