...
public class CH14LogBlock extends RisModElements.ModElement {
	@ObjectHolder("ris:ch_14_log")
	public static final Block block = null;
	public CH14LogBlock(RisModElements instance) {
		super(instance, 116);
	}
