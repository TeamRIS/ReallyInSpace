...
public class CH14SlabBlock extends RisModElements.ModElement {
	@ObjectHolder("ris:ch_14_slab")
	public static final Block block = null;
	public CH14SlabBlock(RisModElements instance) {
		super(instance, 120);
	}
