...
public class OreCompresserBlock extends RisModElements.ModElement {

	@ObjectHolder("ris:ore_compresser")
	public static final Block block = null;

	@ObjectHolder("ris:ore_compresser")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public OreCompresserBlock (RisModElements instance) {
		super(instance, 206);
	...
	@SubscribeEvent public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("ore_compresser"));
	}
				...
				Block
 {
		...
		public CustomBlock() {
			...
			setRegistryName("ore_compresser");
		}
    ...
    public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		@Override public ITextComponent getDefaultName() {
			return new StringTextComponent("ore_compresser");
		}
		...
		@Override public ITextComponent getDisplayName() {
			return new StringTextComponent("Ore Compresser");
		}
