...
public class CH16SlabBlock extends RisModElements.ModElement {
	@ObjectHolder("ris:ch_16_slab")
	public static final Block block = null;
	public CH16SlabBlock(RisModElements instance) {
		super(instance, 171);
	}
