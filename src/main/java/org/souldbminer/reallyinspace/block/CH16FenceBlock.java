...
public class CH16FenceBlock extends RisModElements.ModElement {
	@ObjectHolder("ris:ch_16_fence")
	public static final Block block = null;
	public CH16FenceBlock(RisModElements instance) {
		super(instance, 172);
	}
