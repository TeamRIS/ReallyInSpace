...
public class CH14StairsBlock extends RisModElements.ModElement {
	@ObjectHolder("ris:ch_14_stairs")
	public static final Block block = null;
	public CH14StairsBlock(RisModElements instance) {
		super(instance, 119);
	}
