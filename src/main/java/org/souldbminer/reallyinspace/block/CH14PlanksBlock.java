...
public class CH14PlanksBlock extends RisModElements.ModElement {
	@ObjectHolder("ris:ch_14_planks")
	public static final Block block = null;
	public CH14PlanksBlock(RisModElements instance) {
		super(instance, 117);
	}
