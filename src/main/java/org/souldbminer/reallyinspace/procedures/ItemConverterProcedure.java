...
) != null)) {world.setBlockState(new BlockPos((int)x,(int)(y+1),(int)z), /*@BlockState*/(new Object() {
...
,3);if(!((Entity) world.getEntitiesWithinAABB(ItemEntity.class, new AxisAlignedBB(
            x - (10 / 2d), y - (10 / 2d), z - (10 / 2d),
            x + (10 / 2d), y + (10 / 2d), z + (10 / 2d)), null)
    .stream()
	.sorted(new Object() {
    ...
    ((Entity) world.getEntitiesWithinAABB(ItemEntity.class, new AxisAlignedBB(
            x - (10 / 2d), y - (10 / 2d), z - (10 / 2d),
            x + (10 / 2d), y + (10 / 2d), z + (10 / 2d)), null)
    .stream()
	.sorted(new Object() {
