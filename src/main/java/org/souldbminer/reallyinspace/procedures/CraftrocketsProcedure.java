	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				RisMod.LOGGER.warn("Failed to load dependency x for procedure Craftrockets!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				RisMod.LOGGER.warn("Failed to load dependency y for procedure Craftrockets!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				RisMod.LOGGER.warn("Failed to load dependency z for procedure Craftrockets!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				RisMod.LOGGER.warn("Failed to load dependency world for procedure Craftrockets!");
			return;
		}
