...
public class Pannel2Gui extends RisModElements.ModElement {
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
			this.font.drawString(ms, "Dwarf Planets", 167, 3, -3407872);
			this.font.drawString(ms, "Astroid Belts", 87, 4, -16776961);
			this.font.drawString(ms, "Moons", 258, 3, -1);
			this.font.drawString(ms, "Planets", 26, 4, -205);
			this.font.drawString(ms, "Stars", 352, 2, -13369549);
			this.font.drawString(ms, "Page 1/2", 127, 220, -256);
			this.font.drawString(ms, "Tier 2 Rocket Is needed", 104, 50, -1);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			Search = new TextFieldWidget(this.font, this.guiLeft + 2, this.guiTop + 215, 120, 20, new StringTextComponent("Search Planets")) {
				{
			...
			this.addButton(new Button(this.guiLeft + 14, this.guiTop + 21, 60, 20, new StringTextComponent("Mercury"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));
				handleButtonAction(entity, 0, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 18, this.guiTop + 46, 50, 20, new StringTextComponent("Venus"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(1, x, y, z));
				handleButtonAction(entity, 1, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 19, this.guiTop + 71, 50, 20, new StringTextComponent("Earth"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(2, x, y, z));
				handleButtonAction(entity, 2, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 22, this.guiTop + 96, 45, 20, new StringTextComponent("Mars"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(3, x, y, z));
				handleButtonAction(entity, 3, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 15, this.guiTop + 120, 60, 20, new StringTextComponent("Jupiter"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(4, x, y, z));
				handleButtonAction(entity, 4, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 17, this.guiTop + 141, 55, 20, new StringTextComponent("Saturn"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(5, x, y, z));
				handleButtonAction(entity, 5, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 92, this.guiTop + 23, 55, 20, new StringTextComponent("Astroid"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(6, x, y, z));
				handleButtonAction(entity, 6, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 337, this.guiTop + 19, 60, 20, new StringTextComponent("The Sun"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(7, x, y, z));
				handleButtonAction(entity, 7, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 234, this.guiTop + 19, 100, 20, new StringTextComponent("Earth's Moon #1"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(8, x, y, z));
				handleButtonAction(entity, 8, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 234, this.guiTop + 42, 100, 20, new StringTextComponent("Earth's Moon #2"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(9, x, y, z));
				handleButtonAction(entity, 9, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 257, this.guiTop + 70, 55, 20, new StringTextComponent("Phobos"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(10, x, y, z));
				handleButtonAction(entity, 10, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 256, this.guiTop + 99, 55, 20, new StringTextComponent("Deimos"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(11, x, y, z));
				handleButtonAction(entity, 11, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 259, this.guiTop + 127, 50, 20, new StringTextComponent("Titan"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(12, x, y, z));
				handleButtonAction(entity, 12, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 256, this.guiTop + 151, 55, 20, new StringTextComponent("Europa"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(13, x, y, z));
				handleButtonAction(entity, 13, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 267, this.guiTop + 179, 35, 20, new StringTextComponent("Io"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(14, x, y, z));
				handleButtonAction(entity, 14, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 371, this.guiTop + 211, 45, 20, new StringTextComponent(">>>>"), e -> {
