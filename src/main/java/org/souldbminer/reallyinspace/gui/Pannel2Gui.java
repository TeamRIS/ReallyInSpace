...
@RisModElements.ModElement.Tag public class Pannel2Gui extends RisModElements.ModElement{
	...
	@OnlyIn(Dist.CLIENT) public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		@Override protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
                	this.font.drawString("Dwarf Planets",
						167, 3, -3407872);
                	this.font.drawString("Astroid Belts",
						87, 4, -16776961);
                	this.font.drawString("Moons",
						258, 3, -1);
                	this.font.drawString("Planets",
						26, 4, -205);
                	this.font.drawString("Stars",
						352, 2, -13369549);
                	this.font.drawString("Page 1/2",
						127, 220, -256);
                	this.font.drawString("Tier 2 Rocket Is needed",
						104, 50, -1);
		}
		...
		@Override public void init(Minecraft minecraft, int width, int height) {
			...
			minecraft.keyboardListener.enableRepeatEvents(true);
					...
					Search = new TextFieldWidget(this.font, this.guiLeft + 2, this.guiTop + 215,
															120, 20, "Search Planets")
					{
						{
