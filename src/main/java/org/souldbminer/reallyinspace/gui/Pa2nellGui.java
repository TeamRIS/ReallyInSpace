...
@RisModElements.ModElement.Tag public class Pa2nellGui extends RisModElements.ModElement{
	...
	@OnlyIn(Dist.CLIENT) public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		@Override protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			GL11.glColor4f(1, 1, 1, 1);
						...
						this.blit(this.guiLeft + 254, this.guiTop + 216, 0, 0,
							-1, -1,
							-1, -1);
		}
		...
		@Override protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
                	...
                	this.font.drawString("Planets",
						22, 5, -1);
                	this.font.drawString("Dwarfs",
						91, 2, -1);
                	this.font.drawString("Moons",
						169, 1, -1);
                	this.font.drawString("belts",
						243, 4, -1);
                	this.font.drawString("Page 2/2",
						205, 220, -256);
		}
		...
		@Override public void init(Minecraft minecraft, int width, int height) {
			...
			minecraft.keyboardListener.enableRepeatEvents(true);
					...
					SEarch = new TextFieldWidget(this.font, this.guiLeft + 68, this.guiTop + 217,
