...
public class Pa2nellGui extends RisModElements.ModElement {
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float par1, int par2, int par3) {
			...
			this.blit(ms, this.guiLeft + 254, this.guiTop + 216, 0, 0, -1, -1, -1, -1);
		}
		...
		protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
			this.font.drawString(ms, "Stars", 342, 7, -16711936);
			this.font.drawString(ms, "Planets", 22, 5, -1);
			this.font.drawString(ms, "Dwarfs", 91, 2, -1);
			this.font.drawString(ms, "Moons", 169, 1, -1);
			this.font.drawString(ms, "belts", 243, 4, -1);
			this.font.drawString(ms, "Page 2/2", 205, 220, -256);
		}
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			SEarch = new TextFieldWidget(this.font, this.guiLeft + 68, this.guiTop + 217, 120, 20, new StringTextComponent("Search Planets")) {
				{
			...
			this.addButton(new Button(this.guiLeft + 88, this.guiTop + 113, 50, 20, new StringTextComponent("Ceres"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));
				handleButtonAction(entity, 0, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 319, this.guiTop + 20, 90, 20, new StringTextComponent("Alpha Centuri"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(1, x, y, z));
				handleButtonAction(entity, 1, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 16, this.guiTop + 27, 55, 20, new StringTextComponent("Uranus"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(2, x, y, z));
				handleButtonAction(entity, 2, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 16, this.guiTop + 56, 60, 20, new StringTextComponent("Neptune"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(3, x, y, z));
				handleButtonAction(entity, 3, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 27, this.guiTop + -24, 50, 20, new StringTextComponent("Ceres"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(4, x, y, z));
				handleButtonAction(entity, 4, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 87, this.guiTop + 20, 50, 20, new StringTextComponent("Pluto"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(5, x, y, z));
				handleButtonAction(entity, 5, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 85, this.guiTop + 45, 55, 20, new StringTextComponent("Haumea"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(6, x, y, z));
				handleButtonAction(entity, 6, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 92, this.guiTop + 90, 45, 20, new StringTextComponent("Eris"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(7, x, y, z));
				handleButtonAction(entity, 7, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 12, this.guiTop + 216, 35, 20, new StringTextComponent("<<"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(8, x, y, z));
				handleButtonAction(entity, 8, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 84, this.guiTop + 68, 65, 20, new StringTextComponent("MakeMake"), e -> {
				RisMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(9, x, y, z));
				handleButtonAction(entity, 9, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 233, this.guiTop + 22, 55, 20, new StringTextComponent("Kupier"), e -> {
