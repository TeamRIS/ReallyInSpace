...
@RisModElements.ModElement.Tag public class FuisonTableGui extends RisModElements.ModElement{
	...
	@OnlyIn(Dist.CLIENT) public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		@Override protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(k, l, 0, 0, this.xSize, this.ySize, this.xSize, this.ySize);
						...
						this.blit(this.guiLeft + 81, this.guiTop + 25, 0, 0,
							48, 16,
							48, 16);
		}
