...
@RisModElements.ModElement.Tag public class NasastationGUIGui extends RisModElements.ModElement{
	...
	@OnlyIn(Dist.CLIENT) public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		@Override protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(k, l, 0, 0, this.xSize, this.ySize, this.xSize, this.ySize);
						...
						this.blit(this.guiLeft + 7, this.guiTop + 101, 0, 0,
							-1, -1,
							-1, -1);
						Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("ris:textures/modlogo.png"));
						this.blit(this.guiLeft + 25, this.guiTop + 101, 0, 0,
							-1, -1,
							-1, -1);
						Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("ris:textures/modlogo.png"));
						this.blit(this.guiLeft + 44, this.guiTop + 101, 0, 0,
							-1, -1,
							-1, -1);
						Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("ris:textures/modlogo.png"));
						this.blit(this.guiLeft + 60, this.guiTop + 102, 0, 0,
							-1, -1,
							-1, -1);
						Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("ris:textures/modlogo.png"));
						this.blit(this.guiLeft + 80, this.guiTop + 102, 0, 0,
							-1, -1,
							-1, -1);
						Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("ris:textures/modlogo.png"));
						this.blit(this.guiLeft + 97, this.guiTop + 101, 0, 0,
							-1, -1,
							-1, -1);
						Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("ris:textures/modlogo.png"));
						this.blit(this.guiLeft + 115, this.guiTop + 101, 0, 0,
							-1, -1,
							-1, -1);
						Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("ris:textures/modlogo.png"));
						this.blit(this.guiLeft + 133, this.guiTop + 101, 0, 0,
							-1, -1,
							-1, -1);
						Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("ris:textures/modlogo.png"));
						this.blit(this.guiLeft + 151, this.guiTop + 100, 0, 0,
							-1, -1,
							-1, -1);
		}
		...
		@Override protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
                	this.font.drawString("Craft Here vvvvvvvvvvv",
						33, 64, -12829636);
		}
		...
		@Override public void init(Minecraft minecraft, int width, int height) {
			...
			minecraft.keyboardListener.enableRepeatEvents(true);
                    ...
                    this.addButton(new Button(this.guiLeft + 42, this.guiTop + 7,
						90, 20, "Create Rocket", e -> {
