...
@RisModElements.ModElement.Tag public class MoonDimension extends RisModElements.ModElement{

	@ObjectHolder("ris:moon")
	public static final ModDimension dimension = null;

	@ObjectHolder("ris:moon_portal")
	...
	public MoonDimension (RisModElements instance) {
		super(instance, 90);
	...
	@SubscribeEvent public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("ris:moon")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("ris:moon"), dimension, null, false);
		}

		type = DimensionType.byName(new ResourceLocation("ris:moon"));
	}
	...
	@Override public void init(FMLCommonSetupEvent event) {
		...
		@Override public void initElements() {
			...
			elements.items.add(() -> new MoonItem().setRegistryName("moon"));
		}
...
public static class CustomPortalBlock extends NetherPortalBlock {
	...
	private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
		BlockPattern.PatternHelper bph = MoonDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
...
public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("moon_portal", Vec3i::compareTo, 300);
...
@SubscribeEvent public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
	try {
		...
		poi = (PointOfInterestType) method.invoke(null, "moon_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1);
