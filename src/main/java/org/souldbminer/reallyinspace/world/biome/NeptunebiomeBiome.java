...
@RisModElements.ModElement.Tag public class NeptunebiomeBiome extends RisModElements.ModElement{
	...
	static class CustomBiome extends Biome {
		...
		public CustomBiome() {
			super(new Biome.Builder().downfall(1f)
				.depth(0.1f)
				.scale(0.2f)
				.temperature(-1f)
				...
				Blocks.BLUE_ICE.getDefaultState(), Blocks.PACKED_ICE.getDefaultState(), Blocks.PACKED_ICE.getDefaultState()))
			);
