...
@RisModElements.ModElement.Tag public class SaturnbBiome extends RisModElements.ModElement{
	...
	static class CustomBiome extends Biome {
		...
		public CustomBiome() {
			super(new Biome.Builder().downfall(0f)
				...
				Blocks.PACKED_ICE.getDefaultState(), CompressedmagmaBlock.block.getDefaultState(), CompressedmagmaBlock.block.getDefaultState()))
			);
