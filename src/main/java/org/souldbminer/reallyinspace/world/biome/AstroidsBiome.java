...
@RisModElements.ModElement.Tag public class AstroidsBiome extends RisModElements.ModElement{
	...
	static class CustomBiome extends Biome {
		...
		public CustomBiome() {
			super(new Biome.Builder().downfall(0f)
				...
				Blocks.COBBLESTONE.getDefaultState(), Blocks.STONE.getDefaultState(), Blocks.STONE.getDefaultState()))
			);
